...
class Transformer(tf.keras.models.Model):
    ...
    def call(self, encoder_in, decoder_in, is_train, encoder_padding_mask, decoder_look_ahead_mask, decoder_padding_mask):
        ...
        Returns:
            tuple: (ffn_out, attention_weights)
                - ffn_out: Output cuối cùng, shape (batch_size, tar_seq_len, target_vocab_size)
                - attention_weights: Dictionary chứa các attention weights
        """
        ...
        return ffn_out, attention_weights